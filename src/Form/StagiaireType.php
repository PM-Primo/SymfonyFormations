...
class StagiaireType extends AbstractType
{
    ...
    {
        $builder
        ->add('nom_stagiaire' , TextType::class, ["attr" => ["class" => "form-control"]])
        ->add('prenom_stagiaire' , TextType::class, ["attr" => ["class" => "form-control"]])
        ->add('sexe' , TextType::class, ["attr" => ["class" => "form-control"]])
        ->add('date_naissance' , DateType::class, ['widget' => 'single_text', "attr" => ["class" => "form-control"]])
